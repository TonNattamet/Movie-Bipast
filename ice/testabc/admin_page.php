      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <!-- <li><a class="dropdown-item" href="tabletest.php">Test</a></li> -->
          </ul>
        </li>
      </ul>
...
<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="button-right">
      <a href="formadd.php"><button type="button" class="btn1 btn-sm btn-outline-secondary">Add</button></a>
    </div>  
  <div class="album py-5 bg-dark">
    <div class="container">
      <div class="row"> 
      <?php $query = mysqli_query($conn,"SELECT * FROM data_movie ORDER BY id DESC");
